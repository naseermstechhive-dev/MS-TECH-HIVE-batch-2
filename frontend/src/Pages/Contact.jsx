...
//     <div className="min-h-screen bg-gray-50 dark:bg-gray-900  text-gray-900 transition-colors duration-300">

//       {/* ---------------- HERO SECTION ---------------- */}
//       <div className="text-center py-16 px-6" data-aos="fade-up">
//         <h1 className="text-6xl font-bold mb-6 text-white  " data-aos="zoom-in">
//           Get In Touch
//         </h1>
...
function Contact() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 text-gray-900 dark:text-white transition-colors duration-300">
      ...
      {/* ---------------- HERO SECTION ---------------- */}
      <div className="text-center py-16 px-6" data-aos="fade-up">
        <h1 className="text-6xl font-bold mb-6 text-gray-900 dark:text-white" data-aos="zoom-in">
          Get In Touch
        </h1>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          {/* ---------------- LEFT: CONTACT INFO ---------------- */}
          <div className="space-y-8" data-aos="fade-right">
            <div className="bg-slate-100 dark:bg-slate-800 rounded-3xl p-10 transition">
              <h2 className="text-4xl font-bold mb-10 text-gray-900 dark:text-white" data-aos="zoom-in">
                Contact Information
              </h2>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-5" data-aos="fade-up">
                  ...
                  <div>
                    <div className="font-semibold text-lg text-gray-900 dark:text-white mb-1">Email</div>
                    <div className="text-gray-600 dark:text-gray-400">info@mstechhive.com</div>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-5" data-aos="fade-up" data-aos-delay="150">
                  ...
                  <div>
                    <div className="font-semibold text-lg text-gray-900 dark:text-white mb-1">Phone</div>
                    <div className="text-gray-600 dark:text-gray-400">+91 9032223352</div>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-5" data-aos="fade-up" data-aos-delay="300">
                  ...
                  <div>
                    <div className="font-semibold text-lg text-gray-900 dark:text-white mb-1">Address</div>
                    <a
                      href="https://maps.app.goo.gl/xuJKp9urXsuoBeab9"
                      target="_blank"
                      rel="noopener noreferrer"
                ...
                <div className="flex items-start space-x-5" data-aos="fade-up" data-aos-delay="450">
                  ...
                  <div>
                    <div className="font-semibold text-lg text-gray-900 dark:text-white mb-1">Business Hours</div>
                    <div className="text-gray-600 dark:text-gray-400">Mon - Fri: 9:00 AM - 6:00 PM</div>
                  </div>
                </div>
          ...
          {/* ---------------- RIGHT: FORM ---------------- */}
          <div
            className="bg-slate-100 dark:bg-slate-800 rounded-3xl p-10 transition"
            data-aos="fade-left"
            data-aos-delay="200"
          >
            <h2 className="text-4xl font-bold mb-10 text-gray-900 dark:text-white" data-aos="zoom-in">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div data-aos="fade-up">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="Your full name"
                    className="w-full px-5 py-4 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-xl text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div data-aos="fade-up" data-aos-delay="150">
                  ...
                  <select
                    ...
                    value={formData.industry}
                    onChange={handleChange}
                    className="w-full px-5 py-4 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-xl text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 appearance-none"
                  >
                    <option value="">Select your industry</option>
                    <option value="Hospital">Hospital</option>
                    <option value="School">School</option>
              ...
              <div data-aos="fade-up" data-aos-delay="250">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Tell us about your project or automation needs..."
                  className="w-full px-5 py-4 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-xl text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 resize-none"
                />
              </div>
        ...
        {/* ---------------- WHY CHOOSE US ---------------- */}
        <div className="mt-16 bg-yellow-500 rounded-3xl p-12" data-aos="fade-up">
          <h3 className="text-4xl font-bold mb-8 text-slate-900" data-aos="zoom-in">
            Why Choose Us?
          </h3>
