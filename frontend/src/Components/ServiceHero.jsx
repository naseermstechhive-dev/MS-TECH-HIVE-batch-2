...
const ServiceHero = ({
  ...
  return (
    <section className="  bg-gray-800 py-12 md:py-16 px-6 md:px-10  ">
          ...
          <div data-aos="fade-right" className="space-y-6 md:space-y-8">
            ...
            <div className="flex items-start my-6 space-x-4">
              <div className="w-16 h-16 rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
                <span data-aos="zoom-in" className="text-5xl max-sm:text-[30px]">
                  {typeof logo === 'string' ? logo : React.cloneElement(logo, { className: "text-5xl" })}
                </span>
              </div>
              <div className="space-y-2">
                <h1 data-aos="fade-down" className="text-[44px]  md:text-[44px] lg:text-[48px] font-bold text-white   text-start leading-tight max-sm:text-[30px]">
                  {title}
                </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button onClick={()=>{navigate("/contact")}} data-aos="zoom-out" className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-gray-900 font-bold py-3 px-8 rounded-lg hover:from-yellow-600 hover:to-yellow-700 transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center space-x-2">
                <span>{primaryButton}</span>
                <FaArrowRight className="text-sm" />
              </button>
              
              <button onClick={()=>{navigate("/service")}} data-aos="zoom-in" className="border-2 border-yellow-500 text-yellow-400 font-bold py-3 px-8 rounded-lg hover:bg-yellow-500 hover:text-gray-900 transition-all duration-300 transform hover:scale-105">
                {secondaryButton}
              </button>
            </div>
